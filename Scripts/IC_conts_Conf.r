...
plot(IC_Conts_Conf$Res.1,IC_Conts_Conf$Res,pch=15, cex=1, col=Col, cex.axis=2, cex.lab=2, xlim=rangoresiduos, ylim=rangoresiduos, ylab="Res j", xlab="Res i")
...
legend("topleft",inset=c(-0.22,0),cuts,col=rbPal(10),pch=16, cex=1)
